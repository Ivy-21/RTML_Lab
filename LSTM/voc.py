...
class Voc:
    ...
    def restoreCheckpoint(self, checkpoint):
        self.trimmed = checkpoint['trimmed']
        self.word2index = checkpoint['word2index']
        self.index2word = checkpoint['index2word']
        self.num_words = checkpoint['num_words']
        #print('Got', self.num_words, ' from checkpoint')
